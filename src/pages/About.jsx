    ...
    <div className="min-h-screen bg-gradient-to-br from-[#f8fdff] via-[#eef9ff] to-[#dff4ff]">
      ...
      <section className="max-w-6xl mx-auto px-4 md:px-6 pb-16 md:pb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-center">
          ...
          {/* SHOP IMAGE */}
          <div className="bg-white rounded-3xl shadow-2xl p-3 md:p-4 hover:scale-105 transition duration-300">
            <img
              src={shopImg}
              alt="Dwarka Shop"
              className="w-full h-[250px] sm:h-[350px] md:h-[450px] object-cover rounded-3xl"
            />
          </div>

          {/* TEXT */}
          <div className="text-center md:text-left">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#081B4B] mb-4 md:mb-6">
              Our Story
            </h2>

            <p className="text-[#0B4D8C] text-sm sm:text-base md:text-lg leading-relaxed">
            ...
            <p className="mt-4 md:mt-6 text-[#0B4D8C] text-sm sm:text-base md:text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {features.map((item, index) => (
            ...
            >
              ...
              <p className="mt-3 md:mt-4 text-sm md:text-base text-[#0B4D8C] leading-relaxed">
                {item.desc}
              </p>
            </div>
          ))}
      ...
      {/* STATS */}
      <section className="max-w-6xl mx-auto px-4 md:px-6 pb-16 md:pb-24">
        <div className="bg-gradient-to-r from-[#081B4B] to-[#00A6D6] rounded-3xl shadow-2xl p-6 md:p-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 text-center">
            {stats.map((item, index) => (
              <div key={index}>
                ...
                <p className="mt-2 md:mt-3 text-white text-sm md:text-lg font-medium">
                  {item.label}
                </p>
              </div>
            ))}
      ...
      {/* PROMISE */}
      <section className="max-w-5xl mx-auto px-4 md:px-6 pb-16 md:pb-24 text-center">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-14">
          <h2 className="text-2xl md:text-4xl font-bold text-[#081B4B] mb-6 md:mb-8">
            Our Promise
          </h2>

          <p className="text-lg sm:text-xl md:text-2xl text-[#0B4D8C] leading-relaxed font-medium">
      ...
      {/* CTA */}
      <section className="max-w-6xl mx-auto px-4 md:px-6 pb-20 md:pb-24 text-center">
        <div className="bg-gradient-to-r from-[#eaf8ff] to-[#dff4ff] rounded-3xl p-8 md:p-14 shadow-xl">
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row justify-center gap-4 md:gap-6">
            <a
              href="https://www.zomato.com/solapur/dwarka-falooda-ice-cream-solapur-locality/order"
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 md:px-10 py-4 rounded-full bg-gradient-to-r from-[#081B4B] to-[#00A6D6] text-white font-bold text-base md:text-lg shadow-xl hover:scale-105 transition"
            >
              Order Now
            </a>
            ...
            <a
              href="/contact"
              className="px-8 md:px-10 py-4 rounded-full bg-white text-[#081B4B] font-bold text-base md:text-lg shadow-lg hover:scale-105 transition"
            >
              Contact Us
            </a>
          </div>
